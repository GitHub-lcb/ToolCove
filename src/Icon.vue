...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'key'">
      ...
      <path d="m12 12 8.5-8.5M15 9l3 3M18 6l3 3" />
    </template>
    ...
    <template v-else-if="name === 'git-compare'">
      <circle cx="7" cy="6" r="3" />
      <circle cx="17" cy="18" r="3" />
      <path d="M7 9v9a3 3 0 0 0 3 3h1" />
      <path d="m8 15-3 3 3 3" />
      <path d="M17 15V6a3 3 0 0 0-3-3h-1" />
    ...
    <template v-else-if="name === 'sparkles'">
      ...
      <path d="M18.5 3l.53 1.97 1.97.53-1.97.53L18.5 8l-.53-1.97L16 5.5l1.97-.53z" />
      <path d="M5.5 16l.53 1.97 1.97.53-1.97.53L5.5 21l-.53-1.97L3 18.5l1.97-.53z" />
    </template>
    ...
    <template v-else-if="name === 'flip-horizontal'">
      <path d="M8 3 2 12l6 9V3Z" />
      <path d="m16 3 6 9-6 9V3Z" />
      <path d="M12 2v20" />
    </template>
    <template v-else-if="name === 'flip-vertical'">
      <path d="m3 8 9-6 9 6H3Z" />
      <path d="m3 16 9 6 9-6H3Z" />
      <path d="M2 12h20" />
    </template>
